      ...
      <Link to={fullPath} className="group block h-full">
        ...
        >
          ...
          <div className="p-4 md:p-5 lg:p-6 flex-grow flex flex-col">
            <h3 className="text-xl md:text-2xl font-heading font-semibold text-brand-espresso mb-2 md:mb-3 group-hover:text-brand-gold transition-colors break-words">
              {title}
            </h3>
