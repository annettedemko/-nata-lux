  ...
  return (
    <GlassCard delay={delay} className="overflow-hidden group">
      ...
      <div className="p-4 sm:p-6 md:p-8">
        ...
        {/* Title */}
        <h3 className="text-lg md:text-xl font-heading font-semibold text-brand-espresso mb-3 group-hover:text-brand-gold transition-colors leading-tight break-words">
          {title}
        </h3>
...
export const GlassFeatureCard = ({ title, description, icon: Icon, delay = 0 }: GlassFeatureCardProps) => {
  return (
    <GlassCard delay={delay} className="p-8 text-center">
      ...
      {/* Title */}
      <h3 className="text-xl font-heading font-semibold text-brand-espresso mb-3 break-words">
        {title}
      </h3>
