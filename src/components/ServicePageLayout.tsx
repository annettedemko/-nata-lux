    ...
    <div className="relative min-h-screen">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-20">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          >
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-brand-espresso mb-6 leading-tight break-words px-4" style={{ wordWrap: 'break-word', overflowWrap: 'anywhere', wordBreak: 'break-word', hyphens: 'none', maxWidth: '100%' }}>
              {title}
            </h1>
      ...
      <div className="container mx-auto px-4 max-w-5xl pb-20">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-heading font-semibold text-brand-espresso mb-6 mt-2">
            {aboutTitle}
          </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-brand-espresso mb-1 text-lg">{step.title}</h3>
        ...
        {faq && faq.length > 0 && (
          <motion.section
            ...
            className="mb-12"
          >
            <h2 className="text-2xl md:text-3xl font-heading font-semibold text-brand-espresso mb-8 text-center">
