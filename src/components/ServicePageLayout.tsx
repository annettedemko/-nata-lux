    ...
    <div className="relative w-full overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-20 w-full">
        <div className="container mx-auto px-4 max-w-5xl w-full">
          ...
          >
            ...
            <h1 className="text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl font-heading font-bold text-brand-espresso mb-6 leading-tight px-2 sm:px-4 max-w-full break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', wordWrap: 'break-word' }}>
              {title}
            </h1>
            ...
            >
              ...
              <span className="text-xs tracking-[0.3em] uppercase font-medium">{language === 'de' ? 'Premium Qualität' : language === 'ru' ? 'Премиум качество' : 'Преміум якість'}</span>
              <Sparkles className="w-4 h-4" />
            </motion.div>
          </motion.div>
        </div>
      ...
      <div className="container mx-auto px-4 max-w-5xl pb-6 md:pb-12 w-full">
        ...
        >
          <div className="absolute top-0 left-0 right-0 flex justify-center -translate-y-1/2">
            <div className="px-4 py-1 bg-brand-cream rounded-full border border-brand-gold/20 text-xs text-brand-gold tracking-widest uppercase">
              {language === 'de' ? 'Über die Behandlung' : language === 'ru' ? 'О процедуре' : 'Про процедуру'}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-brand-espresso mb-1 text-base sm:text-lg md:text-xl max-w-full break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', wordWrap: 'break-word' }}>{step.title}</h3>
          ...
          >
            ...
            <div className="relative">
              <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-heading font-semibold text-white mb-4 max-w-full px-2 break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', wordWrap: 'break-word' }}>
                {language === 'de' ? 'Preise & Dauer' : language === 'ru' ? 'Цены и длительность' : 'Ціни та тривалість'}
              </h2>
              <p className="text-white/70 mb-8 max-w-md mx-auto">
                {language === 'de'
                  ...
                  : 'Усі ціни та тривалість процедур ви знайдете на нашій сторінці цін.'}
              </p>
              <Link to={`/prices#${priceSection}`}>
                ...
                >
                  {language === 'de' ? 'Zu den Preisen' : language === 'ru' ? 'К ценам' : 'До цін'}
                </Button>
              </Link>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-brand-coffee/70 mb-6 leading-relaxed">
              {language === 'de'
                ...
                : 'У наступних випадках ми не рекомендуємо цю процедуру:'}
            </p>
          ...
          >
            ...
            <div className="space-y-4">
              {faq.map((item, index) => (
                ...
                >
                  <h3 className="font-semibold text-brand-espresso mb-3 text-base sm:text-lg md:text-xl max-w-full break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', wordWrap: 'break-word' }}>{item.q}</h3>
        ...
        >
          ...
          <div className="relative">
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-heading font-bold text-white mb-4 max-w-full px-2 break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', wordWrap: 'break-word' }}>
              {ctaTitle}
            </h2>
