      ...
      <section className="relative py-16 md:py-20 lg:py-24 bg-gradient-to-br from-brand-latte via-brand-cream to-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-heading font-semibold text-brand-espresso mb-4 md:mb-6 px-2 sm:px-4 max-w-full break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', letterSpacing: '-0.01em', wordWrap: 'break-word' }}>
              {t('antiaging.title')}
            </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-brand-coffee/70 max-w-2xl mx-auto">
              {isGerman
                ? 'Moderne apparative Methoden für Gesicht und Körper ohne OP und Injektionen'
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-brand-cream">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            >
              <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-heading font-semibold text-brand-espresso mb-4 md:mb-6 max-w-full px-2 break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', letterSpacing: '-0.01em', wordWrap: 'break-word' }}>
          ...
          >
            ...
            <div className="space-y-3 md:space-y-4 text-sm md:text-base text-brand-coffee/80 leading-relaxed">
              <p>
                {isGerman
                  ? 'Sichtbare Ergebnisse bereits nach der ersten Behandlung, für stabile Resultate empfehlen wir einen Kurs von 5-10 Sitzungen.'
                  : 'Видимый эффект заметен уже после первой процедуры, но для стабильного результата рекомендуется курс из 5-10 сеансов.'}
              </p>
              <p>
                {isGerman
                  ? 'Alle Behandlungen sind schmerzfrei und erfordern keine Erholungszeit. Sie können sofort in Ihren Alltag zurückkehren.'
                  : 'Все процедуры безболезненны и не требуют восстановительного периода. Вы можете сразу вернуться к обычной жизни.'}
              </p>
              <p className="font-semibold text-brand-espresso">
                {isGerman
                  ? 'Vor Kursbeginn führen wir eine kostenlose Hautdiagnose durch und erstellen ein optimales Behandlungsprogramm.'
                  : 'Перед началом курса проводится бесплатная диагностика кожи и подбор оптимальной программы процедур.'}
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20 bg-gold-gradient relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-heading font-semibold text-white mb-4 md:mb-6 max-w-full px-2 break-words" style={{ hyphens: 'none', wordBreak: 'break-word', overflowWrap: 'anywhere', whiteSpace: 'normal', letterSpacing: '-0.01em', wordWrap: 'break-word' }}>
              {isGerman ? 'Beginnen Sie Ihren Weg zur Jugend' : 'Начните путь к молодости'}
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              {isGerman
                ? 'Vereinbaren Sie einen Beratungstermin und erhalten Sie ein individuelles Anti-Aging-Programm'
